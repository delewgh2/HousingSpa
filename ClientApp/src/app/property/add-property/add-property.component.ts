...
// #endregion
  ...
  onSubmit() {
    ...
    if(this.allTabsValid()) {
      ...
      this.alertify.success('Congrats, your property has been listed successfully on our website!');
      ...
      this.alertify.error('Please review the form and provide all required data');
    }
  }
